...
# source-command-salve

Use this skill when the user asks to run the migrated source command `salve`.
...
**`AGENTS.md` seção 7 (Estado atual):** se o estado macro do projeto mudou, atualize o parágrafo.

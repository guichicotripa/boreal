...
- setorForaDaBase: se a consulta pedir um setor que NÃO está na lista acima (ex: construção, transporte, varejo, alimentos, tecnologia, agro), coloque aqui o nome do setor pedido e devolva cnaePrefixes vazio. NUNCA substitua por um setor indexado. null se o setor pedido está coberto ou se nenhum foi citado.

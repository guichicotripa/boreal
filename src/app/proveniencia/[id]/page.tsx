  ...
  return (
    <main className="mx-auto max-w-lg px-6 py-12">
      <div className="mb-8 flex items-center justify-between">
        ...
        <Link href="/pipeline" className="font-data text-[11px] uppercase tracking-wider text-ink hover:opacity-70">
          ← Pipeline
        </Link>
      </div>
      ...
      {estado === "ok" && cert && (
        <div className="rounded-lg border border-hairline p-6">
          <div className="mb-5 flex items-center justify-between border-b border-hairline pb-4">
            ...
            <span
              className={`font-data text-[10px] uppercase tracking-wider ${cert.valido ? "text-ink" : "text-risk-high"}`}
            >

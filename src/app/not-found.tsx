...
export default function NotFound() {
  return (
    <main className="mx-auto flex w-full max-w-5xl flex-1 flex-col items-start justify-center px-6 py-16">
      ...
      <span
        className="block shrink-0 text-ink-faint"
      ...
      {/* Overline */}
      <p className="mt-8 font-data text-[11px] uppercase tracking-[0.2em] text-ink-soft">
      ...
      {/* Headline */}
      <h1 className="mt-5 max-w-xl font-display text-3xl leading-[1.1] tracking-tight text-ink md:text-[40px]">
      ...
      <Link
        href="/"
        className="group/voltar mt-8 inline-flex items-center gap-1 font-display text-ink transition-opacity hover:opacity-70 focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ink/50 rounded-sm"
      >
